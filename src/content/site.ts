...
export const site = {
  ...
  description:
    "Noble Bidding provides electrical estimation services for contractors across the United States. Send your plans, get a complete takeoff and bid package back in 24 to 48 hours.",
